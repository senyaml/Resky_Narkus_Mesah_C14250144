...
### 🔶 *Node yang digunakan*
  ...
  **CSV Reader**      
  Membaca dataset ToyotaCorolla.csv                                                                                                                                                                                                            
  **Column Filter**   
  Memilih kolom *Price*, *Mfg_Year*, dan *KM*
  
  **Column Renamer**  
  Menstandarkan / merapikan nama kolom
...
# 📦 **Download Workflow**
*https://github.com/senyaml/Resky_Narkus_Mesah_C14250144/releases/tag/download*
